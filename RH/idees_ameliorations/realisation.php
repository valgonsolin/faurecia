...
<div class="boutons_nav" style="display: flex; justify-content: center;">
  <a href="validation.php" class="bouton_menu " style="margin-right:20%">Valider idee</a>
  <a href="realisation.php" class="bouton_menu bouton_nav_selected">Declarer une idee "realisee"</a>
</div>
<br><br>
...
while ($Data = $Query->fetch()) {
  ...
  $c=1;
  $Qy = $bdd->prepare('SELECT * FROM idees_ameliorations WHERE id= ? and date_val IS NULL');
  $Qy->execute(array( $Data['id1']));
  if( $Qy->fetch() ){ $c=0;}
  if($c){ ?>

    <a href="realise.php?idee2= <?php echo $Data['id1'] ; ?>" ><div class="alerte" >
        ...
        <div class="info_alerte">
            ...
            <p><b>Type : </b><?php echo $Data['type'];?><br>
                ...
                <b><?php echo "Cette idée est clasée comme 'réalisée', cliquez pour changer son statut ";?></b><br></p>
...
<?php
  ...
  <a href="realise.php?idee= <?php echo $Data['id1'] ; ?>" ><div class="alerte" >
      ...
      <div class="info_alerte">
          ...
          <p><b>Type : </b><?php echo $Data['type'];?><br>
              ...
              <b><?php if($Data['valide']==1){echo "Cette idée a déja été validé par le manager ";}else{echo "L'idée n'a pas été validé par le manager";} ?></b><br>
              <b>Situation proposée :</b><?php echo $Data['situation_proposee'];?><br><br><br>
              <b><?php echo "Cette idée est clasée comme 'non réalisée', cliquez pour changer son statut ";?></b><br></p>
...
if($debut > 19){
  ?>
  <a href="realisation.php?recherche=<?php echo $recherche;?>&amp;nb=<?php echo $debut-20;?>" class="btn btn-default">Elements précédents</a>
<?php
}
...
if($test -> fetch()){ ?>
  <a href="realisation.php?recherche=<?php echo $recherche;?>&amp;nb=<?php echo $debut+20;?>" class="btn btn-default">Elements suivants</a>
<?php
}
}
drawFooter();
