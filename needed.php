...
global $domain_name;
$url = "http://localhost";
$bdd = new PDO('mysql:host=localhost;dbname=faurecia_beaulieu;charset=utf8', 'root', 'node');
...
?>
    ...
    <div id="header_banner" >
        <a href="<?php echo $url; ?>/index.php" class="lien_accueil"><img src="<?php echo $url; ?>/images/logo2.png"></a>
        <div id="menu">
			...
			<a href="/methode.php"><div class="bouton_menu">Methode</div></a>
